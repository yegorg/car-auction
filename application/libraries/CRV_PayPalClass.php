...
class CRV_PayPalClass extends CI_Controller{
	...
	public function submit_paypal_post() {
		...
		echo "<center><h4>Please wait, your order is being processed and you";
		echo " will be redirected to the paypal website.</h4><br /><img src='/img/ajax-loader.gif' /></center>\n";
		...
		echo "<input type=\"submit\" value=\"Click Here\" class='btn btn-default'></center>\n";
